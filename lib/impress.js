...
( function( document, window ) {
    ...
    var impress = window.impress = function( rootId ) {
        ...
        var prev = function() {
            if (activeStep.classList.contains("playing")) {
              activeStep.classList.add("paused");
              activeStep.classList.remove("playing");
              activeStep.getElementsByTagName("video")[0].pause();
            }
        ...
        var next = function() {
            if (activeStep.classList.contains("paused")) {
              activeStep.classList.add("playing");
              activeStep.classList.remove("paused");
              activeStep.getElementsByTagName("video")[0].play();
            }
            else {
              if (activeStep.classList.contains("playing")) {
                activeStep.classList.add("paused");
